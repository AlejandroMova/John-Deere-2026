...
if page == "Simulación":
    ...
    st.markdown("<hr>", unsafe_allow_html=True)
    st.markdown("### Siembra y Predicciones")
    ...
    with ch_:
        ...
        mnote("Modelo: GDD (base 10°C) + secado del grano (~0.7%/día).")
    ...
    with cn_:
        ...
        for code, k in KS.items():
            ...
            fig_n.add_trace(go.Scatter(
                ...
                line=dict(color=JD_GREEN if sel else BORDER, width=2.5 if sel else 1)))
    ...
    with ct_:
        ...
        fig_t.update_layout(
            ...
            xaxis=dict(gridcolor=BORDER), yaxis=dict(gridcolor=BORDER, range=[0, 45]))
    ...
    with chu_:
        ...
        fig_h.update_layout(
            ...
            xaxis=dict(gridcolor=BORDER), yaxis=dict(gridcolor=BORDER, range=[10, 65]))
